      ...
      <div style={{ width: '100%', maxWidth: '400px', padding: '0 24px' }}>
        <div style={{ background: 'var(--bg-white)', borderRadius: '16px', padding: '48px 32px', boxShadow: 'var(--shadow-medium)' }}>
          <div style={{ textAlign: 'center', marginBottom: '32px' }}>
            ...
            <p style={{ color: 'var(--text-medium)', fontSize: '16px', margin: 0 }}>Logga in på ditt konto</p>
          </div>
          ...
          <div style={{ textAlign: 'center' }}>
            <p style={{ color: 'var(--text-medium)', fontSize: '14px', margin: 0 }}>
              Har du inget konto? <Link href="/register" style={{ color: 'var(--primary-orange)', textDecoration: 'none', fontWeight: '600' }}>Registrera dig</Link>
            </p>
          </div>
        </div>
      </div>
